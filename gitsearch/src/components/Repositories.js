...
const Repositories = (props) => {
  ...
  // this adds the newly loaded repos (from the next page) into the existing repos array
  ...
  useEffect(() => {
    getRepos();
    //disabling because we want an empty array so that the repos call is only made once when page loads.
  ...
  return (
    <Box>
      ...
      <LoadMore
        queryLink={headers.link ? headers.link : ""}
